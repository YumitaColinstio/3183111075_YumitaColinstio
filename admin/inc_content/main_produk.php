...
<div class="card">
    <div class="card-header">
        <div class="col-lg-8">
        <button type="button" class="btn btn-large btn-primary" onclick="showModalAdd();" style="margin-bottom: 5px;">
            <i data-feather="plus-square" style="margin-bottom: 3px;"></i> Add
        </button>
        <input class="form-control-sm py-3 border" type="search" value="" placeholder="Search Product" id="searchproduk" name="searchproduk" onkeyup="searchdt(this.value);">
    </div>    
</div>
    ...
    <table class="table table-hover table-striped">
        ...
        <tr class="">
            <td style="text-align: center;white-space: nowrap;"><?php echo $varCnt; ?></td>
                ...
                <td style="text-align: center;white-space: nowrap;"><?php echo $varStk; ?></td>
...
<div class="modal fade" id="Modal01" tabindex="-1" role="dialog" aria-labelledby="DialogModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #ee9ca7;">
            ...
            <div class="modal-body" style="background-color: #f4e2d8;">
