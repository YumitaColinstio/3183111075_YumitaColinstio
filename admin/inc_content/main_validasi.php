<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Validasi Pembayaran</h1>
</div>
<div class="card">
    <div class="card-header">
        <div class="col-lg-8">
        <input class="form-control-sm py-3 px-4 border" type="search" value="" placeholder="Search Payment" id="searchpem" name="searchpem" onkeyup="searchpem(this.value);">
    </div>    
</div>
    ...
    <table class="table table-hover table-striped">
        ...
        <tbody id="datalist">
            ...
            <tr class="">
                ...
                <td style="text-align: center;white-space: nowrap;"><?php echo $varInVoice;?></td>
                <td style="text-align: center;white-space: nowrap;"><?php echo $varTg;?></td>
                <td style="text-align: center;white-space: nowrap;"><?php echo $varNm;?></td>
                <td style="text-align: center;white-space: nowrap;"><?php echo $varNoRek;?></td>
                <td style="text-align: center;white-space: nowrap;"><?php echo $varNmRek;?></td>
                <td style="text-align: center;white-space: nowrap;"><?php echo $varBank;?></td>
                <td style="text-align: center;white-space: nowrap;"><?php echo number_format($varTot,2);?></td>
                <td style="text-align: center;white-space: nowrap;"><?php echo $varSts;?></td>
                <td style="text-align: center;white-space: nowrap;">
                    <button type="button" onclick="showModalKonfirm(<?php echo $varId; ?>,'<?php echo $varInVoice; ?>');" class="btn btn-success btn-sm" title="Konfirmasi">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button onclick="konfirm();" class="btn btn-success" type="button" data-dismiss="modal">
                    OK's
                </button>
...
<script>
    ...
    function searchpem(srch) {
        $.ajax({
            type: "POST",
            url: "validasi_aksi_cari.php",
            data: { datacari: srch },
            cache: false,
            dataType: "json",
            success: function (data) {
